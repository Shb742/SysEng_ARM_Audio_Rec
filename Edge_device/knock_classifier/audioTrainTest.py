...
#Modified version of FileClassification function to allow classification of 16 bit mono PCM audio segments
def loaded_soundClassification(sound, Fs, model_type, *args):
    # Load classifier:

    classifier, MEAN, STD, classNames, mt_win, mt_step, st_win, st_step, compute_beat = args

    x = numpy.fromstring(sound, numpy.int16)
...
#Modified version of FileClassification function to allow classification of 16 bit mono PCM audio segments
def soundClassification(sound, Fs, model_name, model_type):
    # Load classifier:
